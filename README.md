...
[![NPM Package](https://img.shields.io/npm/v/@owstack/bch-node.svg?style=flat-square)](https://www.npmjs.org/package/@wedontknowjs/bch-node)
...
```bash
npm install -g @wedontknowjs/bch-node
bchnode start
```
